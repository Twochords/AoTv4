...
-- shared-memory: yes
-- author: AoTv4
-- notes: 48 materials: 36 bases carrying the four-way identity (armour types, jewelcraft metals, weapon metals), 9 bindings at group level so Pottery, Alchemy and Jewelcraft are all required, and 3 bought tempers whose price is the per-tier cost ladder.

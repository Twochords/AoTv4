...
bool areAllClassesCasters = false;

// areSpellChoiceWindowEnabled if set to true shows the custom SpellChoiceWnd on
// level-up (driven by the server's \x12SPLCHOICE:...\x12 chat line). Requires

-- Warrior tier 1 -- Cleaving Blow.
-- ⚠️ The payload is aotv4_class_abilities.PAYLOAD[44700]; this file only routes to it.
...
function event_spell_effect(e) ab.fire(44700, e) end

-- Warrior tier 2 -- Bulwark.
-- ⚠️ The payload is aotv4_class_abilities.PAYLOAD[44701]; this file only routes to it.
...
function event_spell_effect(e) ab.fire(44701, e) end

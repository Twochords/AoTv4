...
# (Kunark+ = 60/65/70), so a max-level Bard MUST be able to fight Vox -- the old gate banished
# them to everfrost on enter/aggro/target, making the encounter impossible. Leash logic kept.
my $spawn_x = 0;
my $spawn_y = 0;
my $spawn_z = 0;
my $spawn_h = 0;
